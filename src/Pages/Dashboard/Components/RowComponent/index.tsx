...
export default function Index({  deleteHandler, id,  cs, addNewRow, pageName, edit}) {
...
function gridCalculation (rawqty, bonus , rawrate, rawdis,  updatedRowData , id) {
  ...
  for (const obj of Object.values(updatedRowData)) { 
    netamt2 += parseFloat(obj.netamt ||  0)
  ...
  roundnetamt = netamt2.toFixed(0);
  roundoff  = parseFloat(roundnetamt) - parseFloat(netamt2);
  // ** Unknown Reason NaN of gtot suspects - netamt , netrate, qty , supporters total.
  for (const[k, v] of Object.entries({"gtot": netamt2, "cgst" : ccgst, "sgst": ssgst, "ttaxamt" : ggst, 

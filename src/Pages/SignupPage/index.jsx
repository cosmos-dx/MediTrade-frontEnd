  ...
  function getUserLocation() {
    navigator.geolocation.getCurrentPosition(
      (pos) => {
        ...
        console.log("User's location:", pos.coords);
      },
      (error) => {
        if (error.code === 1) {
          if (confirm("Please provide permission to access your location")) {
          } else {
    ...
    <div className="signup-form-container signup-form-container-mobile">
      ...
      <GoogleMapReact
        ...
        onGoogleApiLoaded={({ map, maps }) => {
          ...
          new maps.Marker({
            position: {lat:currentLocation.coords.lattitude,lng:currentLocation.coords.longitude},
            map,
            title: "Hello World!",
          });
        }}
